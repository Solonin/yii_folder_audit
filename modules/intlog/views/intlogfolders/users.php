                ...
                'value' => function($model){
                    ...
                    foreach($model->adgroupmembers as $adgroupmembers){
                        $items[] = Html::a(
                            ...
                            'http://vsolowinang/intlog/intlogfolders/view2?folder='.$adgroupmembers->folder->folder,
                            [
            ...
            ['attribute' => 'Назначена роль',
                ...
                'value' => function($model){
                    ...
                    foreach($model->rolemembers as $rolemembers){
                        $items[] = Html::a(
                            $rolemembers->role,
                            'http://vsolowinang/intlog/intlogfolders/viewrole?role='.$rolemembers->role,
                            [
                                'title' => 'Посмотреть доступы',
                                'target' => '_blank'
                            ]
